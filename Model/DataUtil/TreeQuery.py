...
def getCppQuery(name):
    if name == "identifiers":
        return """
               (identifier) @id
               """
    if name == "string_literals":
        return """
                (string_content) @id
                (char_literal) @id
                """
    if name == "boolean_literals":
        return """
                (true) @boolean
                (false) @boolean
                """
    if name == "numeric_literals":
        return """
    ...
    if name == "mathematical_operators":
        return (
            r"\+\+|"
            r"--|"
            r"\*=|/=|%=|"
    ...
    if name == "boolean_operators":
        return r"!=|==|&&|\|\||!(?!=)"
    if name == "assignment_operators":
        return r">>=|<<=|\+=|-=|\*=|/=|%=|(?<!&)&=|(?<!\|)\|=|(?<!\^)\^="
